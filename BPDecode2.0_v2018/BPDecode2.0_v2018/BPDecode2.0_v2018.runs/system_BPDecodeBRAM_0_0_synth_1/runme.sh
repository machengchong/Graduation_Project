...
HD_PWD='D:/My_Code/GraduationProject/BPDecode2.0_v2018/BPDecode2.0_v2018/BPDecode2.0_v2018.runs/system_BPDecodeBRAM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_BPDecodeBRAM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_BPDecodeBRAM_0_0.tcl
