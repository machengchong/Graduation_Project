...
for i in range(1, polar_N):
    polar_file.write("\t" + "output reg [BIT - 1:0] OUT_" + str(i) + ",\r")
polar_file.write("\t" + "output reg [BIT - 1:0] OUT_" + str(i + 1) + "\r")
polar_file.write(");" + "\r")
...
for i in range(polar_N):
    polar_file.write("\t"*3 + "OUT_"+str(i+1)+" <= inform_L ["+str(i)+"][0] ;" + "\r")
polar_file.write("\t"*2 + "end" + "\r")
polar_file.write("\t" + "end" + "\r\n")
